...
public:
    ...
    void setx();
    void sety();
    void setEye(const myVector3f & e);
	void setFocus(const myVector3f & f);
...
private:
	myVector3f trackballMapping(int x, int y);
...
protected:
	...
	myVector3f eye;           // eye pos in world
	myVector3f focus;         // objec rotation center
    ...
    myVector3f start;         // the mouse start pos on the great cicle
