...
//typedef svVector3Array svRaster;
//typedef MArray<svRaster> svRasterArray;

     typedef MArray<svVector3Array> svRaster;
     typedef MArray<svRaster> svRasterArray;
     typedef MArray<svScalarArray> svScalar2DArray;
}
#endif // __SV_ARRAY_H
